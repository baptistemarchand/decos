  ...
  style: {
    ...
    "sources": {
      "openmaptiles": {
        "type": "vector",
        "url":
          "https://api.maptiler.com/tiles/v3-openmaptiles/tiles.json?key=eMfrFccitK52Xfwm4QWL",
      },
      "hillshading": {
        "type": "raster",
        "url":
          "https://api.maptiler.com/tiles/hillshade/tiles.json?key=eMfrFccitK52Xfwm4QWL",
        "tileSize": 256,
      },
      "contours": {
        "type": "vector",
        "url":
          "https://api.maptiler.com/tiles/contours/tiles.json?key=eMfrFccitK52Xfwm4QWL",
      },
    },
    "glyphs":
      "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=eMfrFccitK52Xfwm4QWL",
    "layers": [
      {
        "id": "background",
        "type": "background",
